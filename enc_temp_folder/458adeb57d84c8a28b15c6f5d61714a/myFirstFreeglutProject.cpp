...
void draw()
{
    // Background Kanan
    glBegin(GL_QUADS);
    glColor3ub(255, 0, 255); // Warna putih untuk background
    ...
    // BG belakang
    glBegin(GL_QUADS);
    glColor3ub(0, 255, 255); // Warna putih untuk background
    ...
    // Papan tulis
    glBegin(GL_QUADS);
    glColor3ub(255, 255, 255); // Warna hijau untuk papan tulis
    ...
    glBegin(GL_QUADS);
    glColor3ub(255, 255, 255); // Warna hijau untuk alas (tanah)
    ...
    // Tempat duduk
    glBegin(GL_QUADS);
    glColor3ub(0, 0, 255); // Warna hitam
